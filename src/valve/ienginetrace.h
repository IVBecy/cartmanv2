...
{
public:
	CTraceFilter(CBaseEntity* entity) noexcept : skipEntity(entity) { }

	bool ShouldHitEntity(CBaseEntity* entity,int contentsMask) override
	{
...
{
public:
	void TraceRay(const CRay& ray, int mask, const CTraceFilter& filter, CTrace& trace)
	{
		vmt::callFunction<void, const CRay& , int , const CTraceFilter& , CTrace& >(this, 5, ray, mask, filter, trace);
	}
};
